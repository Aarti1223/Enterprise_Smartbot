...
# === Safe GPT Call (v1 API) — Batch of 3 chunks ===
def gpt_extract_batch(chunk_group):
...
def extract_all_records(chunks):
    ...
    for i in range(0, len(chunks), BATCH_SIZE):
        ...
        raw_output = gpt_extract_batch(batch)
...
def main():
    ...
    print("🎉 All done! Use `records.json` for structured access.")
